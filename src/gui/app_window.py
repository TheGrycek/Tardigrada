...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.detectionAlgComboBox = QtWidgets.QComboBox(self.controlTab)
        self.detectionAlgComboBox.setObjectName("detectionAlgComboBox")
        self.detectionAlgComboBox.addItem("")
        self.gridLayout_3.addWidget(self.detectionAlgComboBox, 2, 0, 1, 1)
        self.scaleAlgComboBox = QtWidgets.QComboBox(self.controlTab)
        self.scaleAlgComboBox.setObjectName("scaleAlgComboBox")
        self.scaleAlgComboBox.addItem("")
        self.scaleAlgComboBox.addItem("")
        self.gridLayout_3.addWidget(self.scaleAlgComboBox, 6, 0, 1, 1)
        self.lineAlgComboBox = QtWidgets.QComboBox(self.controlTab)
        self.lineAlgComboBox.setObjectName("lineAlgComboBox")
        self.lineAlgComboBox.addItem("")
        self.lineAlgComboBox.addItem("")
        self.lineAlgComboBox.addItem("")
        self.lineAlgComboBox.addItem("")
        self.gridLayout_3.addWidget(self.lineAlgComboBox, 4, 0, 1, 1)
        self.lineAlgLabel = QtWidgets.QLabel(self.controlTab)
        self.lineAlgLabel.setWordWrap(True)
        self.lineAlgLabel.setObjectName("lineAlgLabel")
        self.gridLayout_3.addWidget(self.lineAlgLabel, 3, 0, 1, 1)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("fugue-icons-3.5.6/icons/geolocation.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.inferenceButton.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("fugue-icons-3.5.6/icons/calculator.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.calculateButton.setIcon(icon1)
        self.calculateButton.setObjectName("calculateButton")
        self.gridLayout_3.addWidget(self.calculateButton, 0, 1, 1, 1)
        self.stopButton = QtWidgets.QPushButton(self.controlTab)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("fugue-icons-3.5.6/icons/minus-circle.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("fugue-icons-3.5.6/icons/arrow-180.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("fugue-icons-3.5.6/icons/arrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("fugue-icons-3.5.6/icons/document.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.openImageButton.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("fugue-icons-3.5.6/icons/question.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menuHelp.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("fugue-icons-3.5.6/icons/folder.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen_Dir.setIcon(icon7)
        self.actionOpen_Dir.setObjectName("actionOpen_Dir")
        self.actionChange_Save_Dir = QtWidgets.QAction(MainWindow)
        self.actionChange_Save_Dir.setIcon(icon7)
        self.actionChange_Save_Dir.setObjectName("actionChange_Save_Dir")
        self.actionSave = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("fugue-icons-3.5.6/icons/disk.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("../../../../../.designer/backup/icon.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAppIcon.setIcon(icon9)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.detectionAlgComboBox.setItemText(0, _translate("MainWindow", "keypoint RCNN"))
        self.scaleAlgComboBox.setItemText(0, _translate("MainWindow", "find-contours + heuristics"))
        self.scaleAlgComboBox.setItemText(1, _translate("MainWindow", "find-conours + linear classifier"))
        self.lineAlgComboBox.setItemText(0, _translate("MainWindow", "B-spline"))
        self.lineAlgComboBox.setItemText(1, _translate("MainWindow", "polynomial"))
        self.lineAlgComboBox.setItemText(2, _translate("MainWindow", "line"))
        self.lineAlgComboBox.setItemText(3, _translate("MainWindow", "curve"))
        self.lineAlgLabel.setText(_translate("MainWindow", "Line fitting algorithm"))
